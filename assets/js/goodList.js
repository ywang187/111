...
$.getJSON("assets/json/product.json?v=1.4", function (data) {
    ...
    if (product != null && product) {
        for (var i = 0; i < product.length; i++) {
            productHtml += '<div>';
            productHtml += '<div class="product-card product-card--2">';
            productHtml += ' <div class="product-card__box">';
            productHtml += ' <div class="product-card__media">';
            productHtml += '  <img class="product-card__img" src="' + product[i].IMAGE_LINK + '" />';
            ...
            productHtml += '<ul>';
            productHtml += ' <li><a class="cart" data-no="' + product[i].PRODUCT_NO + '"><span class="showInfo">Add to cart</span><i class="fas fa-shopping-basket"></i></a></li>';
            productHtml += ' </ul>';
            productHtml += ' </div>';
            productHtml += '</div>';
