...
$('#check').on('click', function () {
    ...
    if (judgeFrom("firstName") && judgeFrom("lastName") && judgeFrom("streetAddress") && judgeFrom("apartment") && judgeFrom("city") && judgeFrom("state") && judgeFrom("phone") && judgeFrom("email") &&
        judgeFrom("firstName_dif") && judgeFrom("lastName_dif") && judgeFrom("streetAddress_dif") && judgeFrom("apartment_dif") && judgeFrom("city_dif") && judgeFrom("state_dif") && judgeFrom("phone_dif") && judgeFrom("email_dif") && judgeFrom("referral")) {
        //验证成功后禁用提交按钮
